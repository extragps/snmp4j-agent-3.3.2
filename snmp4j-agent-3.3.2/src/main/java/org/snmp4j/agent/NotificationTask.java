/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - NotificationTask.java  
  _## 
...
/**
 * The <code>NotificationTask</code> is a <code>Runnable</code> that sends a notifcation or a series of
...
public class NotificationTask implements WorkerTask {
     ...
     *
     * @return an array of ResponseEvent instances (informs) or <code>null</code> values (for traps/notifications).
     */
