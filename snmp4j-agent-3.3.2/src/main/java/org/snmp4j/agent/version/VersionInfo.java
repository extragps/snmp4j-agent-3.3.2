/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - VersionInfo.java  
  _## 
...
/**
 * The {@code VersionInfo} object returns information about the version
...
public class VersionInfo {
  ...
  public static final int DEPENDENCY_SNMP4J_UPDATE = 1;
  public static final String DEPENDENCY_SNMP4J_PATCH = "";

  /**
   * Gets the version string for this release.
   * @return
   *    a string of the form {@code major.minor.update[patch]}.
   */
   ...
   * @return
   *    {@code true} if the dependencies have the minimum required
   *    version(s).
   */
