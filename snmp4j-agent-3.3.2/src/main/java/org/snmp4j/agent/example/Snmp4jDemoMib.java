/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - Snmp4jDemoMib/Colorjava  
  _## 
...
import org.snmp4j.agent.example.ntcip.MonLabel;
import org.snmp4j.agent.example.ntcip.MonMessageStatus;
...
//--AgentGen BEGIN=_STATIC
	static final char[][][] SPARSE_PATTERNS = { {
			{ 'x', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'x' },
			{ ' ', 'x', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'x', ' ' },
			{ ' ', ' ', 'x', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'x', ' ', ' ' },
			{ ' ', ' ', ' ', 'x', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'x', ' ', ' ', ' ' },
...
//--AgentGen END
	 ...
	 */
	public static final OID oidSnmp4jDemoMib = new OID(new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20 });

	// Identities
	// Scalars
	// .1.3.6.1.4.1.4976.10.1.1.20.1.1.0
	public static final OID oidSnmp4jDemoScalar = new OID(new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 1, 1, 0 });
	// 1.3.6.1.4.1.1206.4.2.3.4.13
	public static final OID oidSnmp4jDemoScalarColor =
//		    new OID(new int[] { 1,3,6,1,4,1,4976,10,1,1,20,1,5,0 });
			new OID(new int[] { 1, 3, 6, 1, 4, 1, 1206, 4, 2, 3, 4, 13, 0 });

	public static final OID oidDmsMessageStatus = new OID(new int[] { 1, 3, 6, 1, 4, 1, 1206, 4, 2, 3, 5, 8, 1, 9, 0 });

	public static final OID oidSnmp4jDemoSparseTableType = new OID(
			new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 1, 3, 0 });
	// Tables

	// Notifications
	public static final OID oidSnmp4jDemoEvent = new OID(new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 2, 0, 1 });
	public static final OID oidTrapVarSnmp4jDemoEntryCol3 = new OID(
			new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 1, 2, 1, 5 });
	public static final OID oidTrapVarSnmp4jDemoTableRowModification = new OID(
			new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 1, 2, 1, 9 });
	...
	static final String TC_MODULE_SNMP4J_DEMO_MIB = "SNMP4J-DEMO-MIB";
	static final String TC_SPARSETABLECOLUMN = "SparseTableColumn";
	...
	// Scalars
	private ArrayList<ManagedObject<?>> ntcipObjectList = new ArrayList<ManagedObject<?>>();
	private MOScalar<OctetString> snmp4jDemoScalar;
	private MOScalar<Integer32> snmp4jDemoScalarColor;
	private MOScalar<Integer32> snmp4jDemoSparseTableType;

	private MOScalar<Integer32> ntcipDmsMessageStatus;

	// Tables
	public static final OID oidSnmp4jDemoEntry = new OID(new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 1, 2, 1 });

	// Index OID definitions
	public static final OID oidSnmp4jDemoEntryIndex1 = new OID(
			new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 1, 2, 1, 1 });
	public static final OID oidSnmp4jDemoEntryIndex2 = new OID(
			new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 1, 2, 1, 2 });
	...
	public static final OID oidSnmp4jDemoSparseEntry = new OID(
			new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 1, 4, 1 });

	// Index OID definitions
	public static final OID oidSnmp4jDemoSparseTableIndex = new OID(
			new int[] { 1, 3, 6, 1, 4, 1, 4976, 10, 1, 1, 20, 1, 4, 1, 1 });
	...
	@SuppressWarnings("rawtypes") MOTable<Snmp4jDemoSparseEntryRow, MOColumn, MOMutableTableModel<Snmp4jDemoSparseEntryRow>> snmp4jDemoSparseEntry;
	MOMutableTableModel<Snmp4jDemoSparseEntryRow> snmp4jDemoSparseEntryModel;

	private MonLabel monLabel;
	private MonMessageStatus messageStatus;
...
//--AgentGen END
	...
	protected void createMO(MOFactory moFactory) {
		...
		snmp4jDemoScalar = new Snmp4jDemoScalar(oidSnmp4jDemoScalar,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_WRITE));
		snmp4jDemoScalarColor = new Snmp4jDemoScalarInteger(oidSnmp4jDemoScalarColor,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_WRITE),getMonLabel());
		managedObject = new Snmp4jDemoScalarInteger(
				new OID(new int[] { 1, 3, 6, 1, 4, 1, 1206, 4, 2, 3, 5, 8, 1, 9, 0 }),
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_WRITE),getMessageStatus());
		ntcipObjectList.add(managedObject);

		snmp4jDemoScalar.addMOValueValidationListener(new Snmp4jDemoScalarValidator());
		snmp4jDemoSparseTableType = new Snmp4jDemoSparseTableType(this, oidSnmp4jDemoSparseTableType,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_WRITE));
	...
	public MOScalar<Integer32> getSnmp4jDemoScalarColor() {
		return snmp4jDemoScalarColor;
	}
	...
	private void createSnmp4jDemoEntry(MOFactory moFactory) {
		// Index definition
		snmp4jDemoEntryIndexes = new MOTableSubIndex[] {
				moFactory.createSubIndex(oidSnmp4jDemoEntryIndex1, SMIConstants.SYNTAX_INTEGER, 1, 1),
				moFactory.createSubIndex(oidSnmp4jDemoEntryIndex2, SMIConstants.SYNTAX_OCTET_STRING, 1, 32) };

		snmp4jDemoEntryIndex = moFactory.createIndex(snmp4jDemoEntryIndexes, true, new MOTableIndexValidator() {
		...
		snmp4jDemoEntryColumns[idxSnmp4jDemoEntryCol1] = new MOMutableColumn<Integer32>(colSnmp4jDemoEntryCol1,
				SMIConstants.SYNTAX_INTEGER32, moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE),
				new Integer32(1));
		...
		snmp4jDemoEntryColumns[idxSnmp4jDemoEntryCol2] = new MOMutableColumn<OctetString>(colSnmp4jDemoEntryCol2,
				SMIConstants.SYNTAX_OCTET_STRING, moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE),
		...
		snmp4jDemoEntryColumns[idxSnmp4jDemoEntryCol3] = moFactory.createColumn(colSnmp4jDemoEntryCol3,
				SMIConstants.SYNTAX_COUNTER32, moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_ONLY));
		snmp4jDemoEntryColumns[idxSnmp4jDemoEntryCol4] = moFactory.createColumn(colSnmp4jDemoEntryCol4,
				SMIConstants.SYNTAX_TIMETICKS, moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_ONLY),
				tcModuleSNMPv2Tc, tcDefTimeStamp);
		snmp4jDemoEntryColumns[idxSnmp4jDemoEntryCol5] = new StorageType(colSnmp4jDemoEntryCol5,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), new Integer32(2));
		ValueConstraint snmp4jDemoEntryCol5VC = new EnumerationConstraint(new int[] { 1, 2, 3, 4, 5 });
		...
		snmp4jDemoEntryColumns[idxSnmp4jDemoEntryCol6] = new RowStatus<Snmp4jDemoEntryRow>(colSnmp4jDemoEntryCol6);
		ValueConstraint snmp4jDemoEntryCol6VC = new EnumerationConstraint(new int[] { 1, 2, 3, 4, 5, 6 });
		...
		snmp4jDemoEntryColumns[idxSnmp4jDemoTableRowModification] = moFactory.createColumn(
				colSnmp4jDemoTableRowModification, SMIConstants.SYNTAX_INTEGER,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_NOTIFY));
		// Table model
		snmp4jDemoEntryModel = moFactory.createTableModel(oidSnmp4jDemoEntry, snmp4jDemoEntryIndex,
				snmp4jDemoEntryColumns);
		snmp4jDemoEntryModel.setRowFactory(new Snmp4jDemoEntryRowFactory());
		snmp4jDemoEntry = moFactory.createTable(oidSnmp4jDemoEntry, snmp4jDemoEntryIndex, snmp4jDemoEntryColumns,
	...
	private void createSnmp4jDemoSparseEntry(MOFactory moFactory) {
		// Index definition
		snmp4jDemoSparseEntryIndexes = new MOTableSubIndex[] {
				moFactory.createSubIndex(oidSnmp4jDemoSparseTableIndex, SMIConstants.SYNTAX_INTEGER, 1, 1) };

		snmp4jDemoSparseEntryIndex = moFactory.createIndex(snmp4jDemoSparseEntryIndexes, false,
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableRowStatus] = new RowStatus<Snmp4jDemoSparseEntryRow>(
				colSnmp4jDemoSparseTableRowStatus);
		ValueConstraint snmp4jDemoSparseTableRowStatusVC = new EnumerationConstraint(new int[] { 1, 2, 3, 4, 5, 6 });
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol1] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol1, SMIConstants.SYNTAX_OCTET_STRING,
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol2] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol2, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol3] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol3, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol4] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol4, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol5] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol5, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol6] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol6, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol7] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol7, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol8] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol8, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol9] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol9, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol10] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol10, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol11] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol11, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol12] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol12, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol13] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol13, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol14] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol14, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol15] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol15, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol16] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol16, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol17] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol17, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol18] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol18, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol19] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol19, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol20] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol20, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol21] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol21, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol22] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol22, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol23] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol23, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol24] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol24, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol25] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol25, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol26] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol26, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol27] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol27, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol28] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol28, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol29] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol29, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol30] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol30, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol31] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol31, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol32] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol32, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol33] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol33, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol34] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol34, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol35] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol35, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol36] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol36, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol37] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol37, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol38] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol38, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol39] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol39, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol40] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol40, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol41] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol41, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol42] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol42, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol43] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol43, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol44] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol44, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol45] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol45, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol46] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol46, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol47] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol47, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol48] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol48, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol49] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol49, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		snmp4jDemoSparseEntryColumns[idxSnmp4jDemoSparseTableCol50] = new MOMutableColumn<OctetString>(
				colSnmp4jDemoSparseTableCol50, SMIConstants.SYNTAX_OCTET_STRING,
				moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE), (OctetString) null);
		...
		// Table model
		snmp4jDemoSparseEntryModel = moFactory.createTableModel(oidSnmp4jDemoSparseEntry, snmp4jDemoSparseEntryIndex,
				snmp4jDemoSparseEntryColumns);
		snmp4jDemoSparseEntryModel.setRowFactory(new Snmp4jDemoSparseEntryRowFactory());
		snmp4jDemoSparseEntry = moFactory.createTable(oidSnmp4jDemoSparseEntry, snmp4jDemoSparseEntryIndex,
				snmp4jDemoSparseEntryColumns, snmp4jDemoSparseEntryModel);
	}

	public void registerMOs(MOServer server, OctetString context) throws DuplicateRegistrationException {
		// Scalar Objects
		server.register(this.snmp4jDemoScalar, context);
		server.register(this.snmp4jDemoScalarColor, context);
		for (ManagedObject<?> current : ntcipObjectList) {
			server.register(current, context);
		}
...
//--AgentGen END
	...
	public void unregisterMOs(MOServer server, OctetString context) {
		...
		server.unregister(this.snmp4jDemoScalarColor, context);
		for (ManagedObject<?> current : ntcipObjectList) {
			server.unregister(current, context);
		}
...
//--AgentGen END
	...
	// Notifications
	public void snmp4jDemoEvent(NotificationOriginator notificationOriginator, OctetString context,
			VariableBinding[] vbs) {
		if (vbs.length < 2) {
			throw new IllegalArgumentException("Too few notification objects (snmp4jDemoEvent): " + vbs.length + "<2");
		}
		// snmp4jDemoEntryCol3
		...
		if (!(vbs[1].getOid().startsWith(oidTrapVarSnmp4jDemoTableRowModification))) {
			throw new IllegalArgumentException("Variable 1 (snmp4jDemoTableRowModification)) has wrong OID: "
					+ vbs[1].getOid() + " does not start with " + oidTrapVarSnmp4jDemoTableRowModification);
		}
		if (!snmp4jDemoEntryIndex.isValidIndex(snmp4jDemoEntry.getIndexPart(vbs[1].getOid()))) {
			throw new IllegalArgumentException(
					"Illegal index for variable 1 (snmp4jDemoTableRowModification)) specified: "
...
//--AgentGen END
	...
	// Value Validators
	/**
	 * The <code>Snmp4jDemoScalarValidator</code> implements the value validation
	 * for <code>Snmp4jDemoScalar</code>.
	 */
	...
	/**
	 * The <code>Snmp4jDemoEntryCol1Validator</code> implements the value validation
	 * for <code>Snmp4jDemoEntryCol1</code>.
	 */
	...
	/**
	 * The <code>Snmp4jDemoEntryCol2Validator</code> implements the value validation
	 * for <code>Snmp4jDemoEntryCol2</code>.
	 */
	...
	/**
	 * The <code>Snmp4jDemoEntryCol5Validator</code> implements the value validation
	 * for <code>Snmp4jDemoEntryCol5</code>.
	 */
	...
	/**
	 * The <code>Snmp4jDemoEntryCol6Validator</code> implements the value validation
	 * for <code>Snmp4jDemoEntryCol6</code>.
	 */
	...
	class Snmp4jDemoEntryRowFactory implements MOTableRowFactory<Snmp4jDemoEntryRow> {
		public synchronized Snmp4jDemoEntryRow createRow(OID index, Variable[] values)
				throws UnsupportedOperationException {
			Snmp4jDemoEntryRow row = new Snmp4jDemoEntryRow(index, values);
	...
	class Snmp4jDemoSparseEntryRowFactory implements MOTableRowFactory<Snmp4jDemoSparseEntryRow> {
		public synchronized Snmp4jDemoSparseEntryRow createRow(OID index, Variable[] values)
				throws UnsupportedOperationException {
			Snmp4jDemoSparseEntryRow row = new Snmp4jDemoSparseEntryRow(index, values);
...
//--AgentGen END
	...
	protected void addTCsToFactory(MOFactory moFactory) {
		moFactory.addTextualConvention(new SparseTableColumn(this));
	}
	...
	public MonMessageStatus getMessageStatus() {
		// TODO Auto-generated method stub
		if (null == messageStatus) {
			messageStatus = new MonMessageStatus();
		}
