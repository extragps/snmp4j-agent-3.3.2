...
public class SnmpFrameworkMIB implements MOGroup, TCModule {
    ...
    public SnmpFrameworkMIB(USM usm, Collection<TransportMapping<? extends Address>> transportMappings) {
        this(usm, transportMappings, false);
    }

    public SnmpFrameworkMIB(USM usm, Collection<TransportMapping<? extends Address>> transportMappings, boolean updateUsmFromMIB) {
        this.usm = usm;
     ...
     *
     * @return <code>true</code> if changes are propagated.
     */
