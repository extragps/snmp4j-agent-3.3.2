...
public class UsmMIB
    ...
    public class UsmTableRow extends DefaultMOMutableRow2PC {
        ...
        public AuthenticationProtocol getAuthProtocol(MOTableRow changeSet) {
            ...
            AuthenticationProtocol a = securityProtocols.getAuthenticationProtocol(authOID);
            return a;
        }
         ...
         *
         * @return a privacy protocol OID or <code>null</code> if no
         ...
         *         a TableRow instance with UsmTableRow values.
         *
         * @return an authentication protocol OID or <code>null</code> if no
